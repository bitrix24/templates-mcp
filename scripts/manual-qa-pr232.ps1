...
Has 'server/api/oauth/install.get.ts' 'not-configured`' 'JSDoc mentions not-configured event'
...
Has 'docs/OAUTH-DESIGN.md' 'Carries `ip` and `clientId`'                   'section-11 docs the new payload field'
...
Has 'docs/OAUTH-DESIGN.md' 'X-Frame-Options: DENY` and a strict CSP'      'section-3 mentions extra response headers'
